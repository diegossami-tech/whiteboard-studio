...
function GeometricMotifIcon() {
  return (
    <svg viewBox="0 0 40 40" fill="none" aria-hidden="true">
      ...
      >
        <path d="M20 4.6c2.4 5.1 6.3 9 11.4 11.4C26.3 18.4 22.4 22.3 20 27.4c-2.4-5.1-6.3-9-11.4-11.4C13.7 13.6 17.6 9.7 20 4.6Z" />
        <path d="M20 8.2c-3.9 3.4-6 8.6-5.8 13.8 5.2.2 10.4-1.9 13.8-5.8-3.4-3.9-5.5-9.1-5.8-13.8Z" />
        <path d="M20 8.2c3.9 3.4 6 8.6 5.8 13.8-5.2.2-10.4-1.9-13.8-5.8 3.4-3.9 5.5-9.1 5.8-13.8Z" />
        <path d="M31.8 20c-3.4-3.9-8.6-6-13.8-5.8-.2 5.2 1.9 10.4 5.8 13.8 3.9-3.4 9.1-5.5 13.8-5.8Z" />
        <path d="M8.2 20c3.4-3.9 8.6-6 13.8-5.8.2 5.2-1.9 10.4-5.8 13.8-3.9-3.4-9.1-5.5-13.8-5.8Z" />
        <path d="M20 13.5c1.5 3 3.9 5.4 6.9 6.9-3 1.5-5.4 3.9-6.9 6.9-1.5-3-3.9-5.4-6.9-6.9 3-1.5 5.4-3.9 6.9-6.9Z" />
        <path d="M9.7 6.6h4.8v4.8" />
        <path d="M25.5 6.6h4.8v4.8" />
        <path d="M9.7 28.6h4.8v4.8" />
        <path d="M25.5 28.6h4.8v4.8" />
      </g>
    </svg>
  )
}
